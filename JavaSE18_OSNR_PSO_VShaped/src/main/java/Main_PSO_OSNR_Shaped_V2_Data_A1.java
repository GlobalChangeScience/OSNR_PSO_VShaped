...
import org.implementation.pso_osnr.PSO_OSNR_Position_V2;
import org.model.osnr.OSNR_Model;


public class Main_PSO_OSNR_Shaped_V2_Data_A1
{
    ...
    public static void main(String[] args)
    {
        ...
        OSNR_Data data = reader.read("A1-20x100.json");
        ...
        PSO_OSNR_Position position_move = new PSO_OSNR_Position_V2();
